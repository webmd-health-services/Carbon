...
function New-CRsaKeyPair
{
    ...
    if( -not $NoWarn )
    {
        $msg = 'Carbon''s "New-CRsaKeyPair" function is OBSOLETE and will be removed in the next major version of ' +
               'Carbon. Use the "New-CRsaKeyPair" function in the "Carbon.Cryptography" module, version 3 or later.'
        Write-CWarningOnce -Message $msg
    }
