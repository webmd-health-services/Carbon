...
function Expand-Item
{
    ...
    .DESCRIPTION
    The contents of the ZIP file are extracted to a directory you specify. If the directory doesn't exist, it is created. If the directory exists, and is empty, the file is decompressed into that directory. If the directory isn't empty, use the `-Force` parameter to overwrite any files/directories which may be present.

    The fdirectory where the files were decompressed is returned.
